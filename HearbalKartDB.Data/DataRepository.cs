...
namespace HearbalKartDB.Data
{
	...
	public sealed class DataRepository 
	{
		...
		#region ProdSubcategoryProvider

		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ProdSubcategory"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ProdSubcategoryProviderBase ProdSubcategoryProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ProdSubcategoryProvider;
			}
		}
		...
		#region ProdCategoryMappingProvider

		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ProdCategoryMapping"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ProdCategoryMappingProviderBase ProdCategoryMappingProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ProdCategoryMappingProvider;
			}
		}
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ProdSubcategoryFilters : ProdSubcategoryFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ProdSubcategoryFilters class.
		/// </summary>
		public ProdSubcategoryFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ProdSubcategoryFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ProdSubcategoryFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ProdSubcategoryFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ProdSubcategoryFilters
	
	#region ProdSubcategoryQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ProdSubcategoryParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ProdSubcategory"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ProdSubcategoryQuery : ProdSubcategoryParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ProdSubcategoryQuery class.
		/// </summary>
		public ProdSubcategoryQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ProdSubcategoryQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ProdSubcategoryQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ProdSubcategoryQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ProdSubcategoryQuery
	...
	#region ProdCategoryMappingFilters
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ProdCategoryMappingFilters : ProdCategoryMappingFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ProdCategoryMappingFilters class.
		/// </summary>
		public ProdCategoryMappingFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ProdCategoryMappingFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ProdCategoryMappingFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ProdCategoryMappingFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ProdCategoryMappingFilters
	
	#region ProdCategoryMappingQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ProdCategoryMappingParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ProdCategoryMapping"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ProdCategoryMappingQuery : ProdCategoryMappingParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ProdCategoryMappingQuery class.
		/// </summary>
		public ProdCategoryMappingQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ProdCategoryMappingQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ProdCategoryMappingQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ProdCategoryMappingQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ProdCategoryMappingQuery

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestingPopUpSecond.aspx.cs"
    Inherits="Testing_TestingPopUpSecond" %>
...
<body>
    ...
    <div class="main">
        <div class="panel">
            <a href="#login_form" id="login_pop">Log In</a> <a href="#join_form" id="join_pop">Sign
                Up</a>
        </div>
    </div>
    <!-- popup form #1 -->
    ...
    <div class="popup">
        ...
        <input type="button" value="Sign Up" />&nbsp;&nbsp;&nbsp;or&nbsp;&nbsp;&nbsp;<a href="#login_form"
            id="login_pop">Log In</a> <a class="close" href="#close"></a>
    </div>
</body>
</html>

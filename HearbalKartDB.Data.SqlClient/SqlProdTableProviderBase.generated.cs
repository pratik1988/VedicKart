/*
	...
	Important: Do not modify this file. Edit the file SqlProdTableProvider.cs instead.
*/
...
namespace HearbalKartDB.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlProdTableProviderBase : ProdTableProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlProdTableProviderBase"/> instance.
		/// </summary>
		public SqlProdTableProviderBase()
		{
		}
	...
	public SqlProdTableProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ProdTable)
					,_id);
		...
		public override TList<ProdTable> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<ProdTable>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@TypeId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SupplementId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@MedicineForId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@PurchaseId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SellId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@OfferId", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@ImageUrl", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("typeid ") || clause.Trim().StartsWith("typeid="))
				{
					database.SetParameterValue(commandWrapper, "@TypeId", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("supplementid ") || clause.Trim().StartsWith("supplementid="))
				{
					database.SetParameterValue(commandWrapper, "@SupplementId", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("medicineforid ") || clause.Trim().StartsWith("medicineforid="))
				{
					database.SetParameterValue(commandWrapper, "@MedicineForId", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("purchaseid ") || clause.Trim().StartsWith("purchaseid="))
				{
					database.SetParameterValue(commandWrapper, "@PurchaseId", 
						clause.Trim().Remove(0,10).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("sellid ") || clause.Trim().StartsWith("sellid="))
				{
					database.SetParameterValue(commandWrapper, "@SellId", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("offerid ") || clause.Trim().StartsWith("offerid="))
				{
					database.SetParameterValue(commandWrapper, "@OfferId", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of HearbalKartDB.Entities.ProdTable objects.</returns>
		public override TList<ProdTable> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_Find_Dynamic", typeof(ProdTableColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of HearbalKartDB.Entities.ProdTable objects.</returns>
		public override TList<ProdTable> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetByPurchaseId(TransactionManager transactionManager, System.Int32? _purchaseId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetByPurchaseId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@PurchaseId", DbType.Int32, _purchaseId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByPurchaseId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByPurchaseId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetByItemId(TransactionManager transactionManager, System.Int32? _itemId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetByItemId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ItemId", DbType.Int32, _itemId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByItemId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByItemId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetBySellId(TransactionManager transactionManager, System.Int32? _sellId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetBySellId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@SellId", DbType.Int32, _sellId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetBySellId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetBySellId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetByCompanyId(TransactionManager transactionManager, System.Int32? _companyId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetByCompanyId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetByMedicineForId(TransactionManager transactionManager, System.Int32? _medicineForId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetByMedicineForId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@MedicineForId", DbType.Int32, _medicineForId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMedicineForId", rows)); 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetBySupplementId(TransactionManager transactionManager, System.Int32? _supplementId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetBySupplementId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@SupplementId", DbType.Int32, _supplementId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetBySupplementId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetBySupplementId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdTable> GetByTypeId(TransactionManager transactionManager, System.Int32? _typeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetByTypeId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@TypeId", DbType.Int32, _typeId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByTypeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByTypeId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override HearbalKartDB.Entities.ProdTable GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<ProdTable> tmp = new TList<ProdTable>();
			try
			{
				//Provider Data Requesting Command Event
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<HearbalKartDB.Entities.ProdTable> entities)
		{
			...
			foreach(HearbalKartDB.Entities.ProdTable entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["MedicineForID"] = entity.MedicineForId.HasValue ? (object) entity.MedicineForId  : System.DBNull.Value;
							
				
					row["PurchaseID"] = entity.PurchaseId.HasValue ? (object) entity.PurchaseId  : System.DBNull.Value;
							
				
					row["SellID"] = entity.SellId.HasValue ? (object) entity.SellId  : System.DBNull.Value;
							
				
					row["OfferID"] = entity.OfferId.HasValue ? (object) entity.OfferId  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, HearbalKartDB.Entities.ProdTable entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdTable_Update", _useStoredProcedure);

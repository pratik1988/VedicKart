/*
	...
	Important: Do not modify this file. Edit the file SqlStatesProvider.cs instead.
*/
...
namespace HearbalKartDB.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlStatesProviderBase : StatesProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlStatesProviderBase"/> instance.
		/// </summary>
		public SqlStatesProviderBase()
		{
		}
	...
	public SqlStatesProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<States> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<States>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.States_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@PinCode", DbType.String, DBNull.Value);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<States> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.States_Get_List", _useStoredProcedure);

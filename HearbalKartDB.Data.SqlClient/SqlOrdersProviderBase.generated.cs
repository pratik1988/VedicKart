...
namespace HearbalKartDB.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@OrderStatusId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@BillingId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@TotalAmount", DbType.Int64, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SurveyId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@IsActive", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@IsDeliver", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@IsSurveyDone", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@BookingDate", DbType.DateTime, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@DeletedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("orderstatusid ") || clause.Trim().StartsWith("orderstatusid="))
				{
					database.SetParameterValue(commandWrapper, "@OrderStatusId", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("billingid ") || clause.Trim().StartsWith("billingid="))
				{
					database.SetParameterValue(commandWrapper, "@BillingId", 
				...
				if (clause.Trim().StartsWith("surveyid ") || clause.Trim().StartsWith("surveyid="))
				{
					database.SetParameterValue(commandWrapper, "@SurveyId", 
				...
				if (clause.Trim().StartsWith("isdeliver ") || clause.Trim().StartsWith("isdeliver="))
				{
					database.SetParameterValue(commandWrapper, "@IsDeliver", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("issurveydone ") || clause.Trim().StartsWith("issurveydone="))
				{
					database.SetParameterValue(commandWrapper, "@IsSurveyDone", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("bookingdate ") || clause.Trim().StartsWith("bookingdate="))
				{
					database.SetParameterValue(commandWrapper, "@BookingDate", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Orders> GetByBillingId(TransactionManager transactionManager, System.Int32? _billingId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Orders_GetByBillingId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@BillingId", DbType.Int32, _billingId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByBillingId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByBillingId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Orders> GetByCustomerId(TransactionManager transactionManager, System.Int32? _customerId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Orders> GetByOrderStatusId(TransactionManager transactionManager, System.Int32? _orderStatusId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Orders_GetByOrderStatusId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@OrderStatusId", DbType.Int32, _orderStatusId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByOrderStatusId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByOrderStatusId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override HearbalKartDB.Entities.Orders GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Orders_GetById", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<HearbalKartDB.Entities.Orders> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("OrderStatusID", typeof(System.Int32));
			col2.AllowDBNull = true;		
			DataColumn col3 = dataTable.Columns.Add("BillingID", typeof(System.Int32));
			col3.AllowDBNull = true;		
			DataColumn col4 = dataTable.Columns.Add("TotalAmount", typeof(System.Int64));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("SurveyID", typeof(System.Int32));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("ISActive", typeof(System.Boolean));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("ISDeliver", typeof(System.Boolean));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("IsSurveyDone", typeof(System.Boolean));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("BookingDate", typeof(System.DateTime));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("CreatedDate", typeof(System.DateTime));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("ModifiedDate", typeof(System.DateTime));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("DeletedDate", typeof(System.DateTime));
			col12.AllowDBNull = true;		
			
			bulkCopy.ColumnMappings.Add("ID", "ID");
			bulkCopy.ColumnMappings.Add("CustomerID", "CustomerID");
			bulkCopy.ColumnMappings.Add("OrderStatusID", "OrderStatusID");
			bulkCopy.ColumnMappings.Add("BillingID", "BillingID");
			bulkCopy.ColumnMappings.Add("TotalAmount", "TotalAmount");
			bulkCopy.ColumnMappings.Add("SurveyID", "SurveyID");
			bulkCopy.ColumnMappings.Add("ISActive", "ISActive");
			bulkCopy.ColumnMappings.Add("ISDeliver", "ISDeliver");
			bulkCopy.ColumnMappings.Add("IsSurveyDone", "IsSurveyDone");
			...
			foreach(HearbalKartDB.Entities.Orders entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["OrderStatusID"] = entity.OrderStatusId.HasValue ? (object) entity.OrderStatusId  : System.DBNull.Value;
							
				
					row["BillingID"] = entity.BillingId.HasValue ? (object) entity.BillingId  : System.DBNull.Value;
							
				
					row["TotalAmount"] = entity.TotalAmount.HasValue ? (object) entity.TotalAmount  : System.DBNull.Value;
							
				
					row["SurveyID"] = entity.SurveyId.HasValue ? (object) entity.SurveyId  : System.DBNull.Value;
							
				
					row["ISActive"] = entity.IsActive.HasValue ? (object) entity.IsActive  : System.DBNull.Value;
							
				
					row["ISDeliver"] = entity.IsDeliver.HasValue ? (object) entity.IsDeliver  : System.DBNull.Value;
							
				
					row["IsSurveyDone"] = entity.IsSurveyDone.HasValue ? (object) entity.IsSurveyDone  : System.DBNull.Value;
							
				
					row["BookingDate"] = entity.BookingDate.HasValue ? (object) entity.BookingDate  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, HearbalKartDB.Entities.Orders entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			database.AddInParameter(commandWrapper, "@OrderStatusId", DbType.Int32, (entity.OrderStatusId.HasValue ? (object) entity.OrderStatusId  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@BillingId", DbType.Int32, (entity.BillingId.HasValue ? (object) entity.BillingId  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@TotalAmount", DbType.Int64, (entity.TotalAmount.HasValue ? (object) entity.TotalAmount  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@SurveyId", DbType.Int32, (entity.SurveyId.HasValue ? (object) entity.SurveyId  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@IsDeliver", DbType.Boolean, (entity.IsDeliver.HasValue ? (object) entity.IsDeliver  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@IsSurveyDone", DbType.Boolean, (entity.IsSurveyDone.HasValue ? (object) entity.IsSurveyDone  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@BookingDate", DbType.DateTime, (entity.BookingDate.HasValue ? (object) entity.BookingDate  : System.DBNull.Value));
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, HearbalKartDB.Entities.Orders entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);

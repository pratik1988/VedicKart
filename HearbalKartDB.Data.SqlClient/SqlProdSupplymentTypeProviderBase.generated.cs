/*
	...
	Important: Do not modify this file. Edit the file SqlProdSupplymentTypeProvider.cs instead.
*/
...
namespace HearbalKartDB.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlProdSupplymentTypeProviderBase : ProdSupplymentTypeProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlProdSupplymentTypeProviderBase"/> instance.
		/// </summary>
		public SqlProdSupplymentTypeProviderBase()
		{
		}
	...
	public SqlProdSupplymentTypeProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ProdSupplymentType)
					,_id);
		...
		public override TList<ProdSupplymentType> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<ProdSupplymentType>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@DeletedDate", DbType.DateTime, DBNull.Value);
			...
			//Create Collection
			TList<ProdSupplymentType> rows = new TList<ProdSupplymentType>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of HearbalKartDB.Entities.ProdSupplymentType objects.</returns>
		public override TList<ProdSupplymentType> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Find_Dynamic", typeof(ProdSupplymentTypeColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProdSupplymentType> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of HearbalKartDB.Entities.ProdSupplymentType objects.</returns>
		public override TList<ProdSupplymentType> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override HearbalKartDB.Entities.ProdSupplymentType GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<ProdSupplymentType> tmp = new TList<ProdSupplymentType>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<HearbalKartDB.Entities.ProdSupplymentType> entities)
		{
			...
			bulkCopy.DestinationTableName = "ProdSupplymentType";
			...
			foreach(HearbalKartDB.Entities.ProdSupplymentType entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, HearbalKartDB.Entities.ProdSupplymentType entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Insert", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, HearbalKartDB.Entities.ProdSupplymentType entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ProdSupplymentType_Update", _useStoredProcedure);
